...
codes = [{"code":"FyuU100","system":"readv2"},{"code":"F591000","system":"readv2"},{"code":"F590000","system":"readv2"},{"code":"F59y.00","system":"readv2"},{"code":"H90.5","system":"readv2"},{"code":"H90.2","system":"readv2"},{"code":"H91.9","system":"readv2"},{"code":"H91.8","system":"readv2"},{"code":"H90.8","system":"readv2"}];
REQUIRED_CODES = 1;
